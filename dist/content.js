...
function createLocalStorageFallback() {
  return {
    runtime: {
      getURL: (path) => path,
      sendMessage: (_query, callback) => callback(null),
      lastError: null
    },
    storage: {
...
function createLocalStorageMock(prefix) {
  return {
    get(keys, callback) {
      const result = {};
      if (keys === null) {
...
function getExtensionUrl(path) {
  ...
  if (typeof browser !== "undefined" && ((_b = browser == null ? void 0 : browser.runtime) == null ? void 0 : _b.getURL)) {
    return browser.runtime.getURL(path);
  }
  return null;
}
const storageLog = (msg, ...args) => {
...
class StorageService {
  constructor() {
    __publicField(this, "prefix", "poe-search-");
    __publicField(this, "_syncEnabled", false);
    __publicField(this, "_syncQuotaInfo", null);
    ...
    return new Promise((resolve) => {
      try {
        storageApi.get([formattedKey], (result) => {
          try {
            const payload = result[formattedKey];
            if (!payload) {
  ...
  async setValue(key, value) {
    ...
    return new Promise((resolve, reject) => {
      const payload = { value, expiresAt: null };
  ...
  async setEphemeralValue(key, value, expirationDate) {
    const formattedKey = this.formatKey(key);
    const backend = this.getBackendForKey(key);
    const storageApi = this.getStorageApi(backend);
    return new Promise((resolve, reject) => {
  ...
  async migrateLocalToSync() {
    ...
    const syncableKeys = allLocalKeys.filter(
      (key) => SYNCABLE_KEY_PATTERNS.some((pattern) => key.startsWith(this.prefix + pattern))
    );
    const dataToMigrate = {};
  ...
  async migrateSyncToLocal() {
    ...
    const syncableKeys = syncKeys.filter(
      (key) => SYNCABLE_KEY_PATTERNS.some((pattern) => key.startsWith(this.prefix + pattern))
    );
    for (const key of syncableKeys) {
  ...
  async fetchAllKeysFromBackend(backend) {
    const storageApi = this.getStorageApi(backend);
    return new Promise((resolve) => {
  ...
  async readFromBackend(key, backend) {
    const storageApi = this.getStorageApi(backend);
    return new Promise((resolve) => {
  ...
  async writeToBackend(key, value, backend) {
    const storageApi = this.getStorageApi(backend);
    return new Promise((resolve, reject) => {
...
const useSettingsStore = create((set, get) => ({
  ...
  setDebugLogging: async (enabled) => {
    ...
    const current = await storageService.getValue(SETTINGS_KEY);
    await storageService.setValue(SETTINGS_KEY, { ...current, debugLogging: enabled });
  },
  initialize: async () => {
    console.log("[PoE Search] [Settings] initialize() called");
    try {
      const settings = await storageService.getValue(SETTINGS_KEY);
      const debugEnabled = (settings == null ? void 0 : settings.debugLogging) ?? false;
...
const debugPanel = (message, ...args) => debug.log("Panel", message, ...args);
const debugBookmarks = (message, ...args) => debug.log("Bookmarks", message, ...args);
...
const usePanelStore = create((set, get) => ({
  ...
  initialize: async () => {
    ...
    const [collapsed, activeTab] = await Promise.all([
      storageService.getValue(COLLAPSED_KEY),
      storageService.getValue(ACTIVE_TAB_KEY)
    ]);
...
const Input = reactExports.forwardRef(
  ({ label, error, className = "", ...props }, ref) => {
    return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full", children: [
      label && /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "block text-sm text-poe-beige mb-1 font-fontin", children: label }),
      ...
      error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "mt-1 text-xs text-poe-red", children: error })
    ] });
  }
);
...
function Tabs({ tabs: tabs2, activeTab, onTabChange }) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex border-b border-poe-gray", children: tabs2.map((tab) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      ...
      className: `
            ...
            transition-colors
            ${activeTab === tab.id ? "bg-poe-blue text-poe-white border-b-2 border-poe-gold" : "text-poe-gray-alt hover:bg-poe-gray hover:text-poe-beige"}
          `,
      "data-tab": tab.id,
      children: [
        tab.icon && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "w-5 h-5", children: tab.icon }),
...
function TabPanel({ children, isActive }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 flex flex-col", children });
}
function Modal({ isOpen, onClose, title, children, footer }) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "fixed inset-0 z-50 flex items-center justify-center", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative w-full max-w-md mx-4 bg-poe-black border border-poe-gray rounded-lg shadow-2xl animate-fade-in", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-4 py-3 border-b border-poe-gray", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-fontin text-poe-beige", children: title }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: onClose, "aria-label": "Close", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CloseIcon, {}) })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-4", children }),
      footer && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end gap-2 px-4 py-3 border-t border-poe-gray", children: footer })
    ] })
  ] });
}
function CloseIcon() {
...
function FolderIcon(props) {
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "svg",
    {
      ...
      strokeLinejoin: "round",
      ...props,
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M20 20a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13a2 2 0 0 0 2 2Z" })
    }
  );
}
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "svg",
    {
      ...
      children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("path", { d: "M16 16h5v5" })
      ]
    }
  );
}
function SettingsModal({ isOpen, onClose }) {
  const { debugLogging, setDebugLogging, isLoading, initialize: initialize2 } = useSettingsStore();
  reactExports.useEffect(() => {
    if (isOpen) {
      initialize2();
    }
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      onClose,
      title: "Settings",
      footer: /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", onClick: onClose, children: "Done" }),
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        isLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-poe-gray-alt", children: "Loading..." }) : /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-poe-beige font-fontin", children: "Debug Logging" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-poe-gray-alt", children: "Enable detailed console logs for debugging" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 border-t border-poe-gray", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-xs text-poe-gray-alt", children: "PoE Item Search v1.2.0" }) })
      ] })
    }
  );
}
function PanelHeader() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("header", { className: "flex items-center justify-between px-4 py-3 bg-poe-gray border-b border-poe-gray-alt", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "font-fontin text-xl text-poe-beige tracking-wide", children: "PoE Search" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm text-poe-gray-alt", children: "v1.2.0" })
      ] }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            title: "Settings",
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(SettingsIcon, { className: "w-4 h-4" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Button,
          {
            ...
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(ChevronRightIcon, { className: "w-5 h-5" })
          }
        )
      ] })
    ] }),
...
const tabs = [
  { id: "history", label: "History", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(HistoryIcon, {}) },
  { id: "bookmarks", label: "Bookmarks", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkIcon, {}) },
  { id: "pinned", label: "Pinned", icon: /* @__PURE__ */ jsxRuntimeExports.jsx(PinIcon, {}) }
];
function TabMenu() {
...
function PanelContent({ children }) {
  const { isCollapsed, isLoading, initialize: initialize2 } = usePanelStore();
  reactExports.useEffect(() => {
    initialize2();
  }, [initialize2]);
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-screen bg-poe-black text-poe-beige", children: "Loading..." });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(PanelHeader, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(TabMenu, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0", children })
      ]
    }
  );
}
...
function parseTradeLocation(url) {
  ...
  const version2 = versionPart === "trade2" ? "2" : "1";
  let league = null;
  let slug = null;
...
function buildTradeUrl(location) {
...
const useHistoryStore = create((set, get) => ({
  ...
  fetchEntries: async () => {
    set({ isLoading: true });
    const entries = await storageService.getValue(HISTORY_KEY) ?? [];
  ...
  updateEntryPreviewImage: async (slug, imageUrl) => {
    const entries = await storageService.getValue(HISTORY_KEY) ?? [];
...
function initSearchInterceptor() {
  ...
  window.addEventListener("message", async (event) => {
    ...
    if (((_a = event.data) == null ? void 0 : _a.type) === "poe-search-intercepted" && event.data.payload) {
      await handleInterceptedSearch(event.data.payload);
    }
    if (((_b = event.data) == null ? void 0 : _b.type) === "poe-search-preview-image" && event.data.payload) {
      await handlePreviewImage(event.data.payload);
    }
  });
  debug.log("initSearchInterceptor: listener registered");
}
async function handleInterceptedSearch(payload) {
...
function extractTitleFromQuery(query) {
  ...
  const q = query;
  if ((_a = q.query) == null ? void 0 : _a.term) {
    return q.query.term;
  }
  if ((_b = q.query) == null ? void 0 : _b.type) {
    return q.query.type;
  }
  if ((_c = q.query) == null ? void 0 : _c.name) {
    return q.query.name;
  }
  const category = (_h = (_g = (_f = (_e = (_d = q.query) == null ? void 0 : _d.filters) == null ? void 0 : _e.type_filters) == null ? void 0 : _f.filters) == null ? void 0 : _g.category) == null ? void 0 : _h.option;
  if (category) {
...
async function handlePreviewImage(payload) {
...
function getSearchQuery(item, stats) {
  ...
  const nonResistanceStats = matched.filter(
    (stat) => !resistanceExplicitIds.includes(stat.id) && stat.id !== "explicit.stat_4080418644" && // Strength
    stat.id !== "explicit.stat_3261801346" && // Dexterity
    stat.id !== "explicit.stat_328541901"
    // Intelligence
  );
...
function PasteInput({ onSearch }) {
  const [itemText, setItemText] = reactExports.useState("");
  const [isSearching, setIsSearching] = reactExports.useState(false);
  const [error, setError] = reactExports.useState(null);
  const textareaRef = reactExports.useRef(null);
  const { addEntry } = useHistoryStore();
  const handleSearch = reactExports.useCallback(async (textOverride) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-3 border-b border-poe-gray", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mb-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(ClipboardIcon, { className: "w-4 h-4 text-poe-gold" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-fontin text-sm text-poe-beige", children: "Paste Item" })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Textarea,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mt-2", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt", children: itemText ? "Ctrl+Enter to search" : "Paste to auto-search" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        Button,
        {
          variant: "primary",
          ...
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(SearchIcon, { className: "w-4 h-4 mr-1" }),
...
function extractItemTitle(lines) {
  for (let i = 0; i < Math.min(lines.length, 6); i++) {
    const line = lines[i].trim();
    if (line.startsWith("Item Class:") || line.startsWith("Rarity:") || line === "--------" || !line) {
      continue;
    }
    return line;
  }
...
const useBookmarksStore = create((set, get) => ({
  ...
  updateFolder: async (id, updates) => {
    ...
    const newFolders = folders.map(
      (folder) => folder.id === id ? { ...folder, ...updates } : folder
    );
    await storageService.setValue(FOLDERS_KEY, newFolders);
    set({ folders: newFolders });
  },
  ...
  archiveFolder: async (id) => {
    ...
    await updateFolder(id, { archivedAt: (/* @__PURE__ */ new Date()).toISOString() });
  },
  ...
  fetchTradesForFolder: async (folderId) => {
    const folderTrades = await storageService.getValue(
  ...
  updateTrade: async (folderId, tradeId, updates) => {
    ...
    const newFolderTrades = folderTrades.map(
      (trade) => trade.id === tradeId ? { ...trade, ...updates } : trade
    );
    await storageService.setValue(`${TRADES_KEY_PREFIX}-${folderId}`, newFolderTrades);
    set((state) => ({
      trades: { ...state.trades, [folderId]: newFolderTrades }
...
function formatSortBadge(result) {
...
function getPriceLabel(queryPayload) {
  var _a;
  if (!((_a = queryPayload == null ? void 0 : queryPayload.query) == null ? void 0 : _a.filters)) return null;
  const filters = queryPayload.query.filters;
  const tradeFilters = filters.trade_filters;
  if (!tradeFilters) return null;
  const innerFilters = tradeFilters.filters;
  if (!innerFilters) return null;
  const price = innerFilters.price;
  if (!price || price.max == null || typeof price.max !== "number") return null;
  return {
    max: price.max,
    currency: price.option || "exalted"
    // null means "Exalted Orb Equivalent" (the default)
  };
}
function formatPriceBadge(result) {
  const abbrev = CURRENCY_ABBREVIATIONS[result.currency] || result.currency.slice(0, 3);
  return `≤${result.max}${abbrev}`;
}
function getStatCount(queryPayload) {
  var _a;
  if (!((_a = queryPayload == null ? void 0 : queryPayload.query) == null ? void 0 : _a.stats)) return null;
  let count = 0;
...
function FolderPickerDropdown({
  ...
  reactExports.useEffect(() => {
    if (anchorRef.current) {
      ...
      setPosition({
        ...
        // 192px = dropdown width, keep 8px from edge
      });
    }
  }, [anchorRef]);
  ...
  const dropdown = /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ref: dropdownRef,
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles2.folderList, children: [
          activeFolders.length === 0 && !isCreating && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles2.emptyText, children: "No folders yet" }),
          activeFolders.map((folder) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              style: styles2.folderButton,
              onMouseEnter: (e) => e.currentTarget.style.backgroundColor = "#2a2a2e",
              onMouseLeave: (e) => e.currentTarget.style.backgroundColor = "transparent",
              onClick: () => handleSelectFolder(folder.id),
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(FolderIcon, { style: styles2.folderIcon }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { style: { overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }, children: folder.title })
              ]
            },
            folder.id
          ))
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { style: styles2.separator, children: isCreating ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { style: styles2.inputRow, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "input",
            {
              ref: inputRef,
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              title: "Create folder",
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, { style: { width: "16px", height: "16px" } })
            }
          )
        ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "button",
          {
            style: styles2.newFolderButton,
            onMouseEnter: (e) => {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx(PlusIcon, { style: { width: "16px", height: "16px", flexShrink: 0 } }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "New Folder" })
            ]
          }
        ) })
      ]
  ...
  return reactDomExports.createPortal(dropdown, document.body);
}
...
function SearchEntry({
  ...
  const [showFolderPicker, setShowFolderPicker] = reactExports.useState(false);
  const bookmarkButtonRef = reactExports.useRef(null);
  const timeAgo = createdAt ? getRelativeTime$1(createdAt) : null;
  const sortInfo = getSortLabel(queryPayload == null ? void 0 : queryPayload.sort);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "button",
    {
      onClick: handleClick,
      ...
      children: [
        previewImageUrl && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "shrink-0 w-8 h-8 rounded overflow-hidden bg-poe-dark", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "img",
          {
            src: previewImageUrl,
            alt: "",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-fontin text-sm text-poe-beige truncate", children: title || "Untitled Search" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt shrink-0", children: version2 === "2" ? "PoE2" : "PoE1" }),
            sortInfo && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-accent shrink-0", children: formatSortBadge(sortInfo) }),
            priceInfo && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-accent shrink-0", children: formatPriceBadge(priceInfo) }),
            statCount && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-poe-gray-alt shrink-0", children: [
              statCount,
              " stats"
            ] })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt truncate", children: formatLeague(league) }),
            resultCount !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-poe-gold shrink-0", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: [
          isExecuting ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshIcon, { className: "w-4 h-4 text-poe-gold animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
            canBookmark && /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
              {
                ...
                children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkIcon, { className: "w-4 h-4" })
              }
            ),
            /* @__PURE__ */ jsxRuntimeExports.jsx(
              Button,
          ...
          showFolderPicker && canBookmark && /* @__PURE__ */ jsxRuntimeExports.jsx(
...
function getRelativeTime$1(dateString) {
...
function HistoryTab() {
  const { entries, isLoading, isExecuting, fetchEntries, clearEntries, deleteEntry, executeSearch } = useHistoryStore();
  ...
  const handleBookmark = async (entry, folderId) => {
    const trade = {
      title: entry.title,
      location: {
        version: entry.version,
  ...
  if (isLoading) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center justify-center h-full", children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-poe-gray-alt", children: "Loading..." }) });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-b border-poe-gray", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-sm text-poe-gray-alt", children: [
        entries.length,
        " ",
        entries.length === 1 ? "entry" : "entries"
      ] }),
      entries.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", onClick: clearEntries, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrashIcon, { className: "w-4 h-4 mr-1" }),
        "Clear all"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-y-auto", children: entries.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full p-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-poe-gray-alt mb-2", children: "No search history yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt", children: "Your searches will appear here" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-poe-gray", children: entries.map((entry) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      SearchEntry,
      {
        title: entry.title,
        version: entry.version,
...
function BookmarkModal({ isOpen, onClose }) {
  ...
  const [newFolderTitle, setNewFolderTitle] = reactExports.useState("");
  const [currentLocation, setCurrentLocation] = reactExports.useState(null);
  const [currentHistoryEntry, setCurrentHistoryEntry] = reactExports.useState(null);
  ...
  reactExports.useEffect(() => {
    if (isOpen) {
      ...
      if (historyEntry == null ? void 0 : historyEntry.title) {
  ...
  const folderOptions = reactExports.useMemo(() => {
    return folders.filter((f) => !f.archivedAt).map((f) => ({ value: f.id, label: f.title }));
  }, [folders]);
  const canBookmark = (currentLocation == null ? void 0 : currentLocation.slug) && (currentLocation == null ? void 0 : currentLocation.league) && (currentHistoryEntry == null ? void 0 : currentHistoryEntry.queryPayload);
  const handleCreateFolder = async () => {
    if (!newFolderTitle.trim()) return;
    await createFolder({
      title: newFolderTitle,
      version: (currentLocation == null ? void 0 : currentLocation.version) ?? "2",
      icon: null,
      archivedAt: null
    });
    setNewFolderTitle("");
    setIsCreatingFolder(false);
    const newFolders = await new Promise((resolve) => {
  ...
  const handleBookmark = async () => {
    ...
    if (!(currentLocation == null ? void 0 : currentLocation.slug) || !(currentLocation == null ? void 0 : currentLocation.league)) {
      setError("Cannot bookmark: no search active");
      return;
    }
    if (!(currentHistoryEntry == null ? void 0 : currentHistoryEntry.queryPayload)) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        !canBookmark && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-poe-red/20 border border-poe-red rounded text-sm text-poe-beige", children: !(currentLocation == null ? void 0 : currentLocation.slug) || !(currentLocation == null ? void 0 : currentLocation.league) ? "No active search to bookmark. Perform a search first." : "Search not found in history. Try refreshing the search." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            label: "Title",
        ...
        isCreatingFolder ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-2", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            Input,
            {
          ...
          folderOptions.length > 0 ? /* @__PURE__ */ jsxRuntimeExports.jsx(
            Select,
            {
              label: "Folder",
          ...
          ) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-sm text-poe-gray-alt", children: "No folders yet. Create one to save bookmarks." }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            Button,
            {
              variant: "ghost",
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(PlusIcon, { className: "w-4 h-4 mr-1" }),
                "Create New Folder"
              ]
            }
          )
        ] }),
        error && /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-poe-red", children: error })
      ] })
    }
  );
}
function BookmarksTab() {
  ...
  const [isBookmarkModalOpen, setIsBookmarkModalOpen] = reactExports.useState(false);
  const [newFolderTitle, setNewFolderTitle] = reactExports.useState("");
  const [canBookmark, setCanBookmark] = reactExports.useState(false);
  reactExports.useEffect(() => {
    fetchFolders();
  }, []);
  reactExports.useEffect(() => {
  ...
  reactExports.useEffect(() => {
    const checkLocation = () => {
      const location = getCurrentTradeLocation();
      setCanBookmark(!!((location == null ? void 0 : location.slug) && (location == null ? void 0 : location.league)));
    };
    checkLocation();
    window.addEventListener("popstate", checkLocation);
    const interval = setInterval(checkLocation, 1e3);
    return () => {
  ...
  const visibleFolders = folders.filter(
    (folder) => showArchived ? true : !folder.archivedAt
  );
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-b border-poe-gray", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
        archivedCount > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", onClick: toggleShowArchived, children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(ArchiveIcon, { className: "w-4 h-4 mr-1" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-3 py-2 border-b border-poe-gray", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Button,
      {
        ...
        disabled: !canBookmark,
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkIcon, { className: "w-4 h-4 mr-2" }),
          canBookmark ? "Bookmark Current Search" : "No active search"
        ]
      }
    ) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-y-auto", children: visibleFolders.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full p-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(FolderIcon, { className: "w-8 h-8 text-poe-gray-alt mb-2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-poe-gray-alt mb-2", children: "No bookmarks yet" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt", children: "Create a folder to organize your searches" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-poe-gray", children: visibleFolders.map((folder) => /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarkFolder, { folder }, folder.id)) }) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      Modal,
      {
        ...
        title: "Create Folder",
        footer: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", onClick: () => setIsCreateModalOpen(false), children: "Cancel" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "primary", onClick: handleCreateFolder, children: "Create" })
        ] }),
        children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
...
function BookmarkTrade({ folderId, trade, isExecuting }) {
...
const usePinnedStore = create((set, get) => ({
  items: [],
  isLoading: false,
  fetchItems: async () => {
    set({ isLoading: true });
    const items = await storageService.getValue(PINNED_KEY) ?? [];
  ...
  addItem: async (title, elementSelector) => {
    const { items } = get();
    const newItem = {
      id: uniqueId(),
      title,
...
function PinnedItemsTab() {
  const { items, isLoading, fetchItems, clearItems, scrollToItem, deleteItem } = usePinnedStore();
  reactExports.useEffect(() => {
    fetchItems();
  }, [fetchItems]);
  if (isLoading) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between px-3 py-2 border-b border-poe-gray", children: [
      ...
      items.length > 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs(Button, { variant: "ghost", size: "sm", onClick: clearItems, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(TrashIcon, { className: "w-4 h-4 mr-1" }),
        "Clear all"
      ] })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-1 min-h-0 overflow-y-auto", children: items.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center h-full p-4 text-center", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(PinIcon, { className: "w-8 h-8 text-poe-gray-alt mb-2" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-poe-gray-alt mb-2", children: "No pinned items" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt", children: "Pin items from search results to quickly reference them" })
    ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "divide-y divide-poe-gray", children: items.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      PinnedItem,
      {
        item,
...
function PinnedItem({ item, onScrollTo, onDelete }) {
  const timeAgo = getRelativeTime(item.createdAt);
  return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { className: "group", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start gap-3 px-3 py-2 hover:bg-poe-gray transition-colors", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PinIcon, { className: "w-4 h-4 text-poe-gold shrink-0 mt-0.5" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "block text-sm text-poe-beige truncate", children: item.title }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt", children: timeAgo })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        Button,
        {
          ...
          children: /* @__PURE__ */ jsxRuntimeExports.jsx(SearchIcon, { className: "w-4 h-4" })
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Button, { variant: "ghost", size: "sm", onClick: onDelete, title: "Unpin", children: /* @__PURE__ */ jsxRuntimeExports.jsx(TrashIcon, { className: "w-4 h-4" }) })
    ] })
  ] }) });
}
...
function App() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col h-full", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(PasteInput, {}),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-h-0 flex flex-col overflow-hidden", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabPanel, { isActive: activeTab === "history", children: /* @__PURE__ */ jsxRuntimeExports.jsx(HistoryTab, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabPanel, { isActive: activeTab === "bookmarks", children: /* @__PURE__ */ jsxRuntimeExports.jsx(BookmarksTab, {}) }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(TabPanel, { isActive: activeTab === "pinned", children: /* @__PURE__ */ jsxRuntimeExports.jsx(PinnedItemsTab, {}) })
    ] })
  ] });
}
const version = "1.3.0";
...
async function initialize() {
  try {
    ...
    const toggleRoot = clientExports.createRoot(toggleContainer);
    toggleRoot.render(
      /* @__PURE__ */ jsxRuntimeExports.jsxs(reactExports.StrictMode, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(CollapsedToggle, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(PageLayoutManager, {})
      ] })
    );
    ...
    const panelRoot = clientExports.createRoot(appContainer);
    panelRoot.render(
      /* @__PURE__ */ jsxRuntimeExports.jsx(reactExports.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(PanelContent, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(App, {}) }) })
    );
