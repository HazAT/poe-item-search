...
const extensionApi = () => {
  ...
  if (typeof browser !== "undefined" && ((_b = browser == null ? void 0 : browser.storage) == null ? void 0 : _b.local)) {
    return browser;
  }
  return {
    runtime: {
...
function compareTradeLocations(a, b) {
  return a.version === b.version && a.type === b.type && a.league === b.league && a.slug === b.slug;
}
...
function HistoryEntry({ entry, isExecuting, onExecute, onDelete }) {
  const timeAgo = getRelativeTime$1(entry.createdAt);
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 min-w-0", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-fontin text-sm text-poe-beige truncate", children: entry.title || "Untitled Search" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt shrink-0", children: entry.version === "2" ? "PoE2" : "PoE1" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2 mt-0.5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-poe-gray-alt truncate", children: [
              entry.league,
              " • ",
              entry.type
            ] }),
            entry.resultCount !== void 0 && /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "text-xs text-poe-gold shrink-0", children: [
              entry.resultCount.toLocaleString(),
              " results"
            ] }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt shrink-0", children: timeAgo })
          ] }),
          !hasStoredQuery && /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-poe-gray-alt italic", children: "(legacy - may be expired)" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: isExecuting ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshIcon, { className: "w-4 h-4 text-poe-gold animate-spin" }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
          ...
          hasStoredQuery ? /* @__PURE__ */ jsxRuntimeExports.jsx(RefreshIcon, { className: "w-4 h-4 text-poe-gold", title: "Will re-execute search" }) : /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLinkIcon, { className: "w-4 h-4 text-poe-gray-alt", title: "Legacy link" })
        ] }) })
      ]
    }
  ) });
  ...
  toggleTradeCompleted: async (folderId, tradeId) => {
    ...
    if (trade) {
      await updateTrade(folderId, tradeId, {
        completedAt: trade.completedAt ? null : (/* @__PURE__ */ new Date()).toISOString()
      });
    }
  },
  toggleShowArchived: () => {
...
function BookmarkModal({ isOpen, onClose }) {
  ...
  const canBookmark = (currentLocation == null ? void 0 : currentLocation.slug) && (currentLocation == null ? void 0 : currentLocation.league);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Modal,
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "space-y-4", children: [
        !canBookmark && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 bg-poe-red/20 border border-poe-red rounded text-sm text-poe-beige", children: "No active search to bookmark. Perform a search first." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          Input,
          {
            label: "Title",
...
function BookmarkFolder({ folder }) {
  ...
  const { trades, fetchTradesForFolder, deleteFolder, archiveFolder, unarchiveFolder } = useBookmarksStore();
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          ...
          `,
            ...
            children: isCompleted && /* @__PURE__ */ jsxRuntimeExports.jsx(CheckIcon, { className: "w-3 h-3 text-white" })
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-1 opacity-0 group-hover:opacity-100 transition-opacity", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(ExternalLinkIcon, { className: "w-4 h-4 text-poe-gray-alt" })
        ] })
      ]
    }
  ) });
